...
Populate Article Fact table containing all information of 19 articles 
```{r}
...
#articlesBySeason dataframe is output saved from query on star schema database above
...
Publication productivity by Month (Was there more progress towards publication during certain months of the year?)
```{r}
